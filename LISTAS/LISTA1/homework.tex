...
\begin{homeworkProblem}
    ...
    Faça modelo, exemplo e assertivas de uma matriz dinâmica tridimensional que armazena árvores binárias que referencia lista de matrizes genérias bidimensionais.
...
\begin{homeworkProblem}
    ...
    Dê exemplo de uma hipótese e expelique em que isto auxilia no desenvolvimento de uma aplicação.
...
\begin{homeworkProblem}
    ...
    Mostre através de um exemplo como é possível com um único módulo de definição gerar insterfaces personalizadas para cada módulo cliente.
