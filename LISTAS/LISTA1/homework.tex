...
\begin{homeworkProblem}
    ...
    Sim. Para fazer referência a uma variável definida externamente, em outro módulo, que sera ligada em tempo de linkedição, caso se trate de uma biblioteca estática, ou de execução, tratando-se de uma biblioteca dinâmica.
